...
export const toolPages: ToolPage[] = [
  ...
  },
  {
    ...
    description: 'Reorder, rotate, remove pages, and add text or black cover overlays locally in your browser.',
    ...
    features: [
      ...
      { icon: 'TEXT', text: 'Add text overlays to a selected page or every page.' },
