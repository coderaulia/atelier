...
- Code file size limit: Every code file produced must NOT exceed 800–1,000 lines of code. Proactively decompose oversized chunks into modular sub-components, domain-specific submodules, or dedicated hooks.
