...
export const toolPages: ToolPage[] = [
  ...
  },
  {
    ...
    title: 'Edit PDF Online in Your Browser | Vanaila Studio',
    description: 'Reorder, rotate, remove pages, draw signatures, and add text or black cover overlays locally in your browser.',
    valueProp: 'Make practical PDF edits without uploading confidential documents to a server.',
    ogImage: `${siteUrl}/og/edit-pdf.png`,
    accent: '#38658d',
    features: [
      { icon: 'PAGE', text: 'Move, rotate, and remove pages before export.' },
      { icon: 'TEXT', text: 'Add text overlays directly to the selected page.' },
      { icon: 'SIGN', text: 'Draw and place a signature directly on the PDF page.' },
      { icon: 'BLOCK', text: 'Apply black visual cover blocks.' },
      { icon: 'LOCK', text: 'PDF files stay on your device while you edit.' },
    ],
    faqs: [
      { question: 'Can I edit a PDF without uploading it?', answer: 'Yes. PDF edits and export happen in your browser; files are not uploaded to Vanaila Studio.' },
      { question: 'Can I change text already inside a PDF?', answer: 'No. This tool adds text overlays instead, which is reliable across PDF types.' },
      { question: 'Can I redact private information?', answer: 'No. Cover blocks hide content visually but do not securely remove underlying data. Use a dedicated secure redaction tool for sensitive information.' },
      { question: 'Can I reorder PDF pages?', answer: 'Yes. Select a page, then move it left or right in the document order before exporting.' },
      { question: 'How many pages can I edit?', answer: 'Free edits the first 20 pages. Pro edits up to 100 pages per file.' },
    ],
  },
  {
    slug: 'pdf-powerpoint',
    ...
    title: 'PDF to PowerPoint Converter Online | Vanaila Studio',
    description: 'Convert PDF pages into editable text slides or visual PowerPoint slides in your browser, with no file upload.',
    valueProp: 'Create a PowerPoint presentation from PDF pages privately in your browser.',
    ogImage: `${siteUrl}/og/pdf-to-powerpoint.png`,
    accent: '#38658d',
    features: [
      { icon: 'PPTX', text: 'Download a standard PowerPoint presentation file.' },
      { icon: 'TXT', text: 'Use editable text slides for text-first PDFs.' },
      { icon: 'VIEW', text: 'Use visual slides when the original page design matters.' },
      { icon: 'LOCK', text: 'PDF files stay on your device during conversion.' },
    ],
    faqs: [
      { question: 'Can I convert PDF to PowerPoint without uploading?', answer: 'Yes. PDF processing and PPTX generation run locally in your browser.' },
      { question: 'Are the PowerPoint slides editable?', answer: 'Editable text mode creates text-based slides. Visual mode places each original PDF page as a slide image.' },
      { question: 'Which slide mode should I use?', answer: 'Use editable text for text-first documents you need to revise. Use visual mode for a close representation of the original PDF page.' },
      { question: 'How many PDF pages can I convert?', answer: 'Free converts the first 10 pages. Pro converts up to 50 pages per presentation.' },
      { question: 'Are PowerPoint files stored?', answer: 'No. Your PDF and generated PPTX are handled locally in your browser.' },
    ],
  },
  {
    slug: 'pdf-word',
    ...
    title: 'PDF to Word Converter Online | Vanaila Studio',
    description: 'Convert PDF text into an editable DOCX file in your browser. Private local processing with no document upload.',
    valueProp: 'Turn text-first PDFs into editable Word documents without sending files to a server.',
    ogImage: `${siteUrl}/og/pdf-to-word.png`,
    accent: '#38658d',
    features: [
      { icon: 'DOCX', text: 'Download a real, editable DOCX file.' },
      { icon: 'TXT', text: 'Preserve readable headings, paragraphs, and simple lists.' },
      { icon: '100', text: 'Pro exports larger documents up to 100 pages.' },
      { icon: 'LOCK', text: 'PDF files stay on your device during conversion.' },
    ],
    faqs: [
      { question: 'Can I convert PDF to Word without uploading it?', answer: 'Yes. PDF reading and DOCX generation happen locally in your browser.' },
      { question: 'Is the exported Word file editable?', answer: 'Yes. The tool creates a DOCX document you can open and edit in Word or compatible editors.' },
      { question: 'Will the Word document look exactly like the PDF?', answer: 'Text-first documents convert best. Complex columns, tables, and visual designs may need cleanup after conversion.' },
      { question: 'How many pages can I convert?', answer: 'Free converts the first 10 pages. Pro converts up to 100 pages per file.' },
      { question: 'Does PDF to Word read scanned PDFs?', answer: 'This first release converts selectable PDF text. Use OCR first for scanned PDFs.' },
    ],
  },
  {
    slug: 'pdf-markdown',
    ...
    primaryKeyword: 'PDF to Markdown converter',
    title: 'PDF to Markdown Converter Online | Vanaila Studio',
    description: 'Convert PDF text to editable Markdown in your browser. Private local extraction with Pro OCR for scanned pages.',
    valueProp: 'Turn PDF text into clean, editable Markdown without uploading your document.',
    ogImage: `${siteUrl}/og/pdf-to-markdown.png`,
    accent: '#38658d',
    features: [
      { icon: 'M', text: 'Extract selectable PDF text into editable Markdown.' },
      { icon: 'TXT', text: 'Keep headings and lists readable with layout-aware extraction.' },
      { icon: 'OCR', text: 'Pro OCR reads scanned pages in English or Indonesian.' },
      { icon: 'LOCK', text: 'PDF files stay on your device during conversion.' },
    ],
    faqs: [
      { question: 'Can I convert a PDF to Markdown without uploading it?', answer: 'Yes. Text extraction and export happen in your browser; the PDF is not uploaded to Vanaila Studio.' },
      { question: 'Does PDF to Markdown work with scanned PDFs?', answer: 'Pro users can enable local OCR for scanned pages. PDFs with selectable text convert without OCR.' },
      { question: 'Can I edit the generated Markdown?', answer: 'Yes. Review and edit the Markdown in the browser before copying or downloading the .md file.' },
      { question: 'How many pages can I convert?', answer: 'Free converts the first 10 pages. Pro converts up to 100 pages per file.' },
      { question: 'Will complex PDF layouts convert perfectly?', answer: 'Text-first documents work best. Complex columns, tables, and visual layouts may need light cleanup after conversion.' },
    ],
  },
  {
    slug: 'image-compress',
