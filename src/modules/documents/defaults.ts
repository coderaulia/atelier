...
export const DEFAULT_SOCIAL: Record<string, any> = {
  ...
  ba: { beforeSubtitle: "The way most freelancers work.", before: "A blank page and a deadline.", beforeNote: "Where most projects start.", afterSubtitle: "The way our system works.", after: "A document that earns the deal.", afterNote: "What good work looks like." },
  ...
  story: { kicker: "A Short Story", coverLead: "How we doubled close-rate", coverItalic: "in a quarter.", slides: "The Problem — You're getting views but no conversions. Here's why.\nThe Shift — Treat the document as part of the product, not an afterthought.\nThe Result — Clients sign faster. Briefs come back warmer. Work compounds." },
  tipscarousel: { kicker: "Field Notes", titleItalic: "I keep close.", subtitle: "What I've learned shipping freelance work for the better part of a decade.", tips: "Write the email before the spec.\nPrice the outcome, not the hour.\nNever pitch what you can't deliver.\nDocument decisions, not opinions.\nShip the smallest useful thing." },
  booking: { label: "Now Booking", lead: "Two spots open for", window: "Q3", project: "projects.", subtext: "Brand and product work. Four-to-six-week engagements. Friendly intake, written deliverables, no agency overhead.", ctaText: "Inquire via DM" },
  ...
  question: { kicker: "Question of the Week", question: "Are you a freelancer", questionAccent: "or a hobbyist?", answer: "The difference is not how good you are. It's whether someone is paying you to be that good before next Tuesday.", ctaText: "Reply your answer →" },
  ...
  tutorial: { kicker: "Tutorial", duration: "60 sec", prefix: "How to", what: "rebrand a", whatItalic: "small studio", steps: "Audit existing brand touchpoints.\nMap the customer journey.\nWrite the headline first.\nDesign in low-fi.\nShip and iterate.", ctaText: "Watch full" },
  ...
  casestudyv: { client: "Atlas & Bell", year: "2026", image: "", stat: "+312%", resultLabel: "The result", statLabel: "increase in qualified leads in the first 90 days post-launch.", tag1: "Brand", tag2: "Web", tag3: "8 weeks" },
  pov: { kicker: "POV:", scene: "It's Friday at 4pm. The invoice clears. You ", action: "close the laptop", tail: " and start the weekend.", endTag: "— the dream" },
  ...
  team1: { kicker: "Welcome to the Team", badge: "New Joiner", image: "", name: "Elena Rostova", position: "Lead Brand Designer", department: "Brand Studio · London", bio: "Joining our studio to lead brand identity and digital design systems.", bg: "" },
  ...
  team4: { kicker: "Team Expansion", headline: "Welcoming 4 new team members", image1: "", name1: "Elena Rostova", position1: "Brand Lead", image2: "", name2: "Marcus Vance", position2: "Creative Director", image3: "", name3: "Aria Chen", position3: "Staff Engineer", image4: "", name4: "Sophia Ray", position4: "Product Strategist", bg: "" },

  /* New News with Photos Defaults */
  newshero: { category: "Industry Report", date: "May 2026", image: "", tag: "Exclusive", headline: "Freelance studios now win 75% of venture-backed branding briefs", synopsis: "New quarterly data reveals enterprise founders increasingly bypass agency rosters in favor of specialized solo partners.", bg: "" },
  newssplit: { category: "Press", image: "", kicker: "Market Dispatch", headline: "The industry-wide shift towards asynchronous studio retainers", takeaways: "54% increase in retainer proposals signed year-on-year\nClient demand shifts from agency headcount to solo masters\nAverage proposal contract size up 35% across Q2", bg: "" },
  newsinterview: { kicker: "Founder Spotlight", publication: "Issue No. 14", image: "", speaker: "Marcus Bell", title: "Managing Partner · Atlas", quote: "The studios that win in 2026 are the ones that treat documents as brand assets, not administrative paperwork.", context: "On the future of modern document design", bg: "" },

  /* New Pricing Defaults */
  pricing: { kicker: "Proposal No. 01", packageName: "Brand Starter", price: 1500, currency: "USD", features: "Logo + brand mark\nColor palette & type system\nBrand guidelines (12 pages)\n2 revision rounds\nSource files included", ctaText: "DM to get started →", bg: "" },
  pricing3tier: { kicker: "Investment & Plans", headline: "Transparent packages for every project stage", tier1Name: "Starter", tier1Price: "$1,200", tier1Desc: "Essential brand foundations", tier1Features: "Logo mark & wordmark\nCurated color palette\nType system & pairing\n1 Revision cycle", tier2Name: "Pro Package", tier2Price: "$3,500", tier2Desc: "Complete identity system", tier2Features: "Complete brand identity\n32-Page design system\nClient document templates\n3 Revision rounds\nAll vector source files", tier3Name: "Studio Partner", tier3Price: "$6,000", tier3Desc: "Custom end-to-end scope", tier3Features: "Strategy & positioning\nFull multi-platform kit\nOngoing monthly advisory\nPriority 48h turnaround\nDirect private Slack", bg: "" },
  pricingretainer: { kicker: "Studio Retainer", availability: "2 Spots Available for Q3", packageName: "Dedicated Design Partner", rate: "$4,500", tagline: "Senior-level design bandwidth without the agency overhead.", deliverables: "Dedicated private Slack channel\n48-Hour average turnaround on briefs\nUnlimited request queue (1 active at a time)\nDesign systems, decks & client docs\nPause or cancel anytime with notice", ctaText: "Inquire via DM →", bg: "" },
  pricingaudit: { kicker: "Fixed-Scope Sprint", duration: "2-Week Turnaround", headline: "Proposal & Document System Teardown", price: "$1,800", deliverables: "24-Page comprehensive teardown report\nComplete copy & pricing structure overhaul\nCustom production-ready template in Figma\n60-Minute live strategic review session", ctaText: "Book Sprint →", bg: "" },

  /* New Vertical Carousels Defaults */
  v_story: { kicker: "Case Study", clientName: "Atlas & Bell", year: "2026", coverHeadline: "How we doubled client close-rate in 60 days", slides: "The Friction — Low proposal response rate and inconsistent client-facing assets.\nThe Shift — Rebuilt the document system from the ground up with custom typography.\nThe Result — Proposal close rate climbed from 22% to 68% within two weeks.", metric: "+240% Growth", outcome: "Ready to transform your client proposals?", ctaText: "Work with us →", bg: "" },
  v_tips: { kicker: "Framework", title: "5 Rules for High-Converting Proposals", subtitle: "Field notes from shipping freelance documents that win enterprise deals.", tips: "Write the email first — Before opening design tools, define the decision in one sentence.\nPrice the outcome — Never bill by the hour when clients buy business certainty.\nMap the constraints — Real limits on time, scope and budget build immediate trust.\nShow the finished work — Visual proof of past deliverables always outperforms slides.\nShip in daylight — Clear communication beats endless internal revision cycles.", bg: "" },
  v_threads: { authorName: "Marcus Bell", authorHandle: "@marcusbell_", posts: "The hardest part of freelancing isn't finding clients.\n\nIt's having the courage to charge for the value of your thinking instead of the hours you sat in your chair.\n---\nWhen you sell hours, clients manage your schedule.\n\nWhen you sell outcomes, clients trust your direction.\n---\nThree things that instantly elevate a client proposal:\n\n1. Fixed-scope deliverable list\n2. 2-Tier pricing (never more)\n3. Clear milestone payment schedule\n---\nDocument design is product design for your service.\n\nTreat your proposal like the first feature of the project.", replies: "184", reposts: "72", likes: "1.6k", bg: "" },

  testimonial: { kicker: "Client proof", quote: "Working with this studio changed how I think about proposals entirely. We closed our next deal the same week.", clientName: "Priya Bell", clientTitle: "Co-Founder · Atlas & Bell", clientPhoto: "" },
