...
export const TOOLS: ToolDefinition[] = [
  ...
  },
  {
    ...
    description: 'Extract PDF text into editable Markdown',
    icon: <FilePdfIcon />,
    category: 'pdf',
    publicPath: '/pdf-to-markdown',
    appPath: '/app/pdf-to-markdown',
    component: lazy(() => import('@/modules/pdf-markdown/PDFMarkdownTool')),
    freeDailyLimit: 3,
    proOnly: false,
    badge: 'new',
  },
  {
    ...
    icon: <FilePdfIcon />,
    category: 'pdf',
    publicPath: '/pdf-to-word',
    appPath: '/app/pdf-to-word',
    component: lazy(() => import('@/modules/pdf-word/PDFWordTool')),
    freeDailyLimit: 3,
    proOnly: false,
    badge: 'new',
  },
  {
    ...
    icon: <FilePdfIcon />,
    category: 'pdf',
    publicPath: '/pdf-to-powerpoint',
    appPath: '/app/pdf-to-powerpoint',
    component: lazy(() => import('@/modules/pdf-powerpoint/PDFPowerPointTool')),
    freeDailyLimit: 3,
    proOnly: false,
    badge: 'new',
  },
  {
    id: 'pdf-edit',
    name: 'Edit PDF',
    description: 'Reorder pages and add text or cover overlays',
    icon: <FilePdfIcon />,
    category: 'pdf',
    publicPath: '/edit-pdf',
    appPath: '/app/edit-pdf',
    component: lazy(() => import('@/modules/pdf-edit/PDFEditTool')),
    freeDailyLimit: 3,
    proOnly: false,
    badge: 'new',
  },
